      ...
      <div className="mx-auto container f-f-p px-4 xl:px-0 py-24">
        ...
        <div className="md:mt-24 f-f-p">
          <div className="hidden md:flex justify-center w-full">
            <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
              ...
              <div className="flex mt-12 flex-col items-center lg:items-end md:w-8/12">
                <h1 className="focus:outline-none text-xl font-bold leading-5">Doubt Clear</h1>
                <h2 className="focus:outline-none text-gray-500 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide">On call get your questions convert into your plan and ready to get fitter body.</h2>
              </div>
            ...
            <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
              ...
              <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
                <h1 className="focus:outline-none text-xl font-bold leading-5">SignUp for training session</h1>
                <h2 className="focus:outline-none text-gray-500 mt-3 text-base leading-6 tracking-wide">Post SignUp we will contact you within 24 hours to get your fitness plan ready to workout. </h2>
              </div>
              ...
              <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
                <h1 className="focus:outline-none text-xl font-bold leading-5">Start your Fitness journey</h1>
                <h2 className="focus:outline-none text-gray-500 mt-3 text-base leading-6 tracking-wide">Pay the 50% amount to get start your journey</h2>
              </div>
            </div>
          </div>
          <div className="md:hidden flex flex-col items-center w-full">
            ...
            <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/3_step_center_aligned_how_it_worksSvg4.svg" alt />
            <div className="mt-10">
              <h1 className="text-xl text-center tracking-wide leading-5 font-bold">Doubt Clear</h1>
              <h2 className="text-gray-500 mt-3 text-center text-base leading-6 tracking-wide">On call get your questions convert into your plan and ready to get fitter body.</h2>
            </div>
            ...
            <div className="mt-10">
              <h1 className="text-xl tracking-wide text-center leading-5 font-bold">SignUp for training session</h1>
              <h2 className="text-gray-500 mt-3 pl-3 text-center text-base leading-6 tracking-wide">Post SignUp we will contact you within 24 hours to get your fitness plan ready to workout. </h2>
            </div>
            ...
            <div className="flex mt-10 flex-col items-center md:items-start md:w-8/12">
              <h1 className="text-xl text-center tracking-wide leading-5 font-bold">Start your Fitness journey</h1>
              <h2 className="text-gray-500 mt-3 text-center text-base leading-6 tracking-wide">Pay the 50% amount to get start your journey</h2>
            </div>
          </div>
        </div>
      </div>
