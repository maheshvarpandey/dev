            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div className="flex justify-between ">
                    <div className="hidden sm:flex flex-row items-center space-x-6">
                        <a href="https://twitter.com/trainer_dev" target="_blank">
                        ...
                        <a href="https://www.facebook.com/dev.singhaniya.921" target="_blank">
                            <svg className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.instagram.com/fitnesscoach.dev/" target="_blank">
                            <svg className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className=" flex space-x-3 items-center">
                        ...
                        <h1 className=" font-normal text-2xl leading-6 text-gray-800 font-bold">Dev Fitness</h1>
                    </div>
