                    ...
                    <div className=" lg:w-1/2 w-full">
                        ...
                        <div className="w-56">
                            <div className="bg-gray-100 shadow rounded-full flex items-center mt-10">
                                <button onClick={() => setMonthlyPlan(true)} className={`${monthlyPlan ? "bg-indigo-700" : "bg-indigo-100"} focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none text-base leading-none text-white rounded-full py-4 px-6 mr-1`} id="monthly">
                                    Monthly
                                </button>
                                <button onClick={()=> setMonthlyPlan(false)} className={`${monthlyPlan ? "bg-indigo-100" : "bg-indigo-700"} focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none text-base leading-none text-white rounded-full py-4 px-6`} id="annually">
                                    Annually
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="xl:w-1/2 lg:w-7/12 relative w-full lg:mt-0 mt-12 md:px-8" role="list">
                        ...
                        <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg p-8 relative z-30">
                            <div className="md:flex items-center justify-between">
                                <h2 className="text-2xl font-semibold leading-6 text-gray-800">Demo</h2>
                                <p className="text-2xl font-semibold md:mt-0 mt-4 leading-6 text-gray-800">FREE</p>
                            </div>
                            <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">If you are planning to take the service with me in GYM then you will get a free training session</p>
                        </div>
                        <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                            ...
                            <div className="w-full p-8">
                                <div className="md:flex items-center justify-between">
                                    <h2 className="text-2xl font-semibold leading-6 text-gray-800">Personal Training</h2>
                                    <p className="text-2xl md:mt-0 mt-4 font-semibold leading-6 text-gray-800">
                                    {monthlyPlan ? "RS 8K" : "RS 7.5K"}<span className="font-normal text-base">/mo</span>
                                    </p>
                                </div>
                                <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">Ultimate Personal Training and full support on diet</p>
                            </div>
                        </div>
